    ...
    return (
      ...
      <div className="w-full h-[100vh] pb-5">
        ...
        <div className='w-full h-[100%] flex items-center justify-center'>
          ...
          />
          <Cards 
          label="To create a safe, engaging, and enjoyable learning platform that supports early childhood education, providing interactive content that helps kids learn and grow."
          styleType="card7"
          Title="Our Mission"
      ...
      <div className='w-full h-[25vh] bg-[#6EDBD0] flex gap-20 px-20'>
        ...
        <div className='w-full py-9 flex flex-col items-center gap-1'>
          ...
          <p className='cursor-pointer' onClick={handleFaq}>FAQ's</p>
        </div>
